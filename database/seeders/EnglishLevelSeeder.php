    ...
    public function run(): void
    {
        $levels = [
            ...
            [
                ...
                'name_uz' => 'O\'rtadan oldingi',
                'description' => 'Bridge level between Elementary and Intermediate. Can handle familiar situations with more confidence.',
                'description_uz' => 'Boshlang\'ich va O\'rta daraja o\'rtasidagi ko\'prik. Tanish vaziyatlarni ko\'proq ishonch bilan hal qiladi.',
                'can_do_statements' => [
                    'listening' => ['Can understand main points of extended discussion', 'Can follow changes of topic in formal discussion'],
                    'speaking' => ['Can maintain simple face-to-face conversation', 'Can give or seek personal views in informal discussion'],
                    'reading' => ['Can understand straightforward factual texts', 'Can recognize significant points in newspaper articles'],
                    'writing' => ['Can write simple connected text', 'Can write personal letters giving news and expressing thoughts']
                ],
                'vocabulary_target' => 1800,
                'grammar_structures' => 42,
                'estimated_hours' => 240,
                'xp_required' => 13000,
                'xp_to_complete' => 12000,
                'ielts_band_min' => 3.5,
                'ielts_band_max' => 4.0,
                'color' => 'cyan',
                'icon' => '🌊',
