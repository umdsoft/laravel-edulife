...
use App\Services\English\FillTheGapDataService;
use App\Services\English\FillTheGapService;
use Illuminate\Http\Request;
use Inertia\Inertia;

class FillTheGapController extends Controller
{
    protected FillTheGapDataService $dataService;
    protected FillTheGapService $gameService;

    public function __construct(FillTheGapDataService $dataService, FillTheGapService $gameService)
    {
    ...
    public function index()
    {
        ...
        $gapMasterRanks = $this->dataService->getGapMasterRanks();

        return Inertia::render('English/Games/FillTheGap/Index', [
            'levels' => $levels,
            'stats' => $stats,
            'config' => $config,
    ...
    public function play(int $level)
    {
        ...
        if (!$levelData) {
            return redirect()->route('student.english.games.fill-the-gap.index')
        ...
        return Inertia::render('English/Games/FillTheGap/Play', [
            'level' => $levelData,
            'config' => $config,
            'gameModes' => $gameModes,
            'powerups' => $powerups,
