...
use App\Services\English\HangmanDataService;
use App\Services\English\HangmanService;
...
class HangmanController extends Controller
{
    ...
    protected HangmanService $gameService;

    public function __construct(HangmanDataService $dataService, HangmanService $gameService)
    {
    ...
    public function index()
    {
        ...
        $wordMasterRanks = $this->dataService->getWordMasterRanks();

        return Inertia::render('English/Games/Hangman/Index', [
            'levels' => $levels,
            'stats' => $stats,
            'config' => $config,
            ...
            'wordMasterRanks' => $wordMasterRanks,
        ]);
    }
    ...
    public function play(int $level)
    {
        ...
        if (!$levelData) {
            return redirect()->route('student.english.games.hangman.index')
        ...
        return Inertia::render('English/Games/Hangman/Play', [
            'level' => $levelData,
            'config' => $config,
            'gameModes' => $gameModes,
            'powerups' => $powerups,
    ...
    public function guessLetter(Request $request)
    {
        ...
        try {
            $result = $this->gameService->guessLetter(
    ...
    public function nextWord(Request $request)
    {
        ...
        try {
            $result = $this->gameService->nextWord($request->input('session_id'));
