...
use App\Services\English\BeatTheClockDataService;
use App\Services\English\BeatTheClockService;
use Illuminate\Http\Request;
use Inertia\Inertia;

class BeatTheClockController extends Controller
{
    protected BeatTheClockDataService $dataService;
    protected BeatTheClockService $gameService;

    public function __construct(BeatTheClockDataService $dataService, BeatTheClockService $gameService)
    {
    ...
    public function index()
    {
        ...
        $timeMasterRanks = $this->dataService->getTimeMasterRanks();

        return Inertia::render('English/Games/BeatTheClock/Index', [
            'levels' => $levels,
            'stats' => $stats,
            'config' => $config,
            ...
            'timeMasterRanks' => $timeMasterRanks,
        ]);
    }
    ...
    public function play(int $level)
    {
        ...
        if (!$levelData) {
            return redirect()->route('student.english.games.beat-the-clock.index')
        ...
        return Inertia::render('English/Games/BeatTheClock/Play', [
            'level' => $levelData,
            'config' => $config,
            'gameModes' => $gameModes,
            'powerups' => $powerups,
