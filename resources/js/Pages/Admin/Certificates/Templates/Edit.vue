<template>
    <AdminLayout>
        ...
        <Head title="Shablonni Tahrirlash" />
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Shablonni tahrirlash: {{ form.name }}</h1>
        </div>
        ...
        <form @submit.prevent="submit" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="bg-white rounded-2xl shadow-sm p-6 space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Yangi PDF/Rasm (O'zgartirish
                            uchun)</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Yangi Thumbnail</label>
...
const previewImage = ref(props.template.thumbnail_path ? `/storage/${props.template.thumbnail_path}` : null);

const form = useForm({
    _method: 'PUT',
    name: props.template.name,
    description: props.template.description,
    direction_id: props.template.direction_id,
    course_id: props.template.course_id,
    pdf_template: null,
    thumbnail: null,
    ...
    settings: props.template.settings,
});
...
const submit = () => {
    form.post(`/admin/certificate-templates/${props.template.id}`);
};
</script>
