...
const completedLevels = computed(() => props.levels.filter(l => l.is_completed).length)

const startLevel = (level) => {
    if (!level.is_unlocked) return
    router.visit(`/student/english/games/sentence-builder/play/${level.number}`)
}

const gameModes = [
    { icon: '🔄', name: "So'zlarni joylashtirish", desc: "Aralash so'zlarni to'g'ri tartibga qo'ying" },
    { icon: '🎯', name: "Grammatik qoidalar", desc: "Har bir gap grammatik qoidaga asoslangan" },
    { icon: '⏱️', name: "Tezkor o'rganish", desc: "Qisqa vaqtda ko'p gaplar tuzing" },
    { icon: '💡', name: "Yordam tizimi", desc: "Qiynalsangiz, hint oling" },
]

const tips = [
    { icon: '⚡', text: "Tez javob bersangiz, bonus ball olasiz!" },
    { icon: '⭐', text: "3 ta yulduz olish uchun 90%+ aniqlik kerak" },
    { icon: '🔥', text: "Ketma-ket to'g'ri javoblar streak bonus beradi" },
]
</script>

<template>

    <Head title="Gap Quruvchi - Sentence Builder" />

    <StudentLayout>
        <div class="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-violet-900 -m-4 sm:-m-6 lg:-m-8 -mt-8 p-4 sm:p-6 font-sans">

            <!-- Premium Hero Section -->
            <div class="relative overflow-hidden rounded-[2rem] mb-8">
                <!-- Animated Gradient Background -->
                <div class="absolute inset-0 bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-600">
                    <!-- Animated Orbs -->
                    <div class="absolute top-0 left-1/4 w-72 h-72 bg-cyan-500/30 rounded-full blur-3xl animate-pulse" />
                    <div class="absolute bottom-0 right-1/4 w-64 h-64 bg-purple-500/30 rounded-full blur-3xl animate-pulse"
                        style="animation-delay: 1s" />
                    <div class="absolute top-1/2 right-0 w-48 h-48 bg-pink-500/20 rounded-full blur-3xl animate-pulse"
                ...
                <div class="absolute inset-0 pointer-events-none overflow-hidden">
                    ...
                    <span class="floating-emoji" style="left: 12%; top: 60%; animation-delay: 1.2s;">✨</span>
                        ...
                        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
                            ...
                            <div class="flex-1 text-center lg:text-left">
                                ...
                                <div
                                    ...
                                    <span class="text-white text-sm font-medium">✨ Yangi Interaktiv O'yin</span>
                                </div>

                                <!-- Main Title -->
                                <div class="flex items-center justify-center lg:justify-start gap-5 mb-4">
                                    <div
                                        class="w-16 h-16 md:w-20 md:h-20 bg-white/20 backdrop-blur rounded-2xl flex items-center justify-center shadow-2xl shadow-blue-500/30 border border-white/20">
                                        <span class="text-4xl md:text-5xl">📝</span>
                                    </div>
                                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tight drop-shadow-lg">
                                        Gap <span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-blue-300">Quruvchi</span>
                                    </h1>
                                </div>

                                <p class="text-lg md:text-xl text-white/90 mb-6 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                                    Ingliz tili <span class="text-cyan-300 font-bold">grammatikasini</span> o'yin orqali o'rganing!
                                    So'zlarni to'g'ri joylashtiring va <span class="text-yellow-300 font-bold">mukammal gaplar</span> tuzing.
                                </p>
                            ...
                            <div class="hidden xl:block relative w-72 h-72 flex-shrink-0 animate-float">
                                <div
                                    class="absolute inset-0 bg-gradient-to-tr from-blue-400/30 to-purple-400/30 blur-2xl rounded-full">
                                </div>
                                <div
                                    ...
                                    <div class="space-y-2">
                                        <div
                                            class="h-9 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg w-3/4 shadow-lg flex items-center px-3 font-bold text-white/90 text-sm">
                                            Subject</div>
                                        <div
                                            class="h-9 bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-lg w-1/2 shadow-lg flex items-center px-3 font-bold text-white/90 text-sm translate-x-6">
                                            Verb</div>
                                        <div
                                            class="h-9 bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg w-full shadow-lg flex items-center px-3 font-bold text-white/90 text-sm">
                                            Object</div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="max-w-[1600px] mx-auto px-2 md:px-4">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center gap-4">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center shadow-lg">
                            <span class="text-2xl">📚</span>
                        </div>
                        <div>
                            <h2 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">Barcha Darajalar</h2>
                            <p class="text-gray-500 dark:text-gray-400 text-sm">A1 dan C2 gacha - grammatik mavzular</p>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                    <div v-for="level in levels" :key="level.number" @click="startLevel(level)"
                        ...
                        :class="[level.is_unlocked ? 'hover:scale-[1.03] hover:-translate-y-2' : 'opacity-60 cursor-not-allowed grayscale-[0.3]']">
                        ...
                        <div class="relative h-28 flex items-center px-4" :style="{
                            ...
                            <div class="flex items-center gap-3 flex-1 relative z-10">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <h3 class="font-bold text-white text-lg truncate">{{ level.name_uz }}</h3>
                                </div>
                            </div>
                            ...
                            <div v-if="!level.is_unlocked"
                                ...
                                <span class="text-white font-bold text-sm">{{ level.required_stars_to_unlock }} ⭐ kerak</span>
                            </div>
                        ...
                        <div class="p-4">
                            ...
                            <!-- Progress Bar -->
                            <div v-if="level.is_unlocked" class="mb-3">
                                <div class="flex justify-between text-xs text-gray-500 dark:text-gray-400 mb-1.5">
                                    <span>Progress</span>
                                    <span class="font-bold" :style="{ color: level.accent_color }">
                                        {{ Math.round((level.sentences_completed / level.sentences_to_complete) * 100) }}%
                                    </span>
                                </div>
                                <div class="h-2 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                                    <div class="h-full rounded-full transition-all duration-500"
                                        :style="{ width: `${Math.min(100, (level.sentences_completed / level.sentences_to_complete) * 100)}%`, background: `linear-gradient(90deg, ${level.accent_color}, ${adjustColor(level.accent_color, 20)})` }" />
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700">
                                <div class="flex gap-3 text-xs text-gray-500 dark:text-gray-400">
                                    <span class="flex items-center gap-1 font-medium">
                                        <span class="text-base">⚡</span> {{ level.rewards?.xp_completion || 0 }} XP
                                    </span>
                                    <span class="flex items-center gap-1 font-medium">
                                        <span class="text-base">🪙</span> {{ level.rewards?.coins_completion || 0 }}
                                    </span>
                                </div>
            ...
            <Teleport to="body">
                <div v-if="showTutorial"
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-3xl max-w-lg w-full shadow-2xl overflow-hidden animate-scale-in max-h-[90vh] overflow-y-auto">
                        <!-- Modal Header -->
                        <div class="relative bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-600 p-6 text-center">
                            ...
                            <h3 class="text-2xl font-black text-white mb-1">Gap Quruvchi</h3>
                        ...
                        <div class="p-5 space-y-4">
                            ...
                            <div class="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 border border-green-200 dark:border-green-800">
                                ...
                                <p class="text-green-700 dark:text-green-300 text-sm">
                                    Berilgan <strong>aralash so'zlarni</strong> to'g'ri tartibda joylashtiring va grammatik jihatdan to'g'ri gap tuzing!
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center gap-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-2.5">
                                        <div class="w-6 h-6 bg-blue-500 text-white text-xs font-bold rounded flex items-center justify-center flex-shrink-0">1</div>
                                        <p class="text-gray-800 dark:text-gray-200 text-sm">O'zbekcha tarjimani o'qing</p>
                                    </div>
                                    <div class="flex items-center gap-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg p-2.5">
                                        ...
                                        <p class="text-gray-800 dark:text-gray-200 text-sm">So'zlarni bosib yoki tortib joylashtiring</p>
                                    </div>
                                    <div class="flex items-center gap-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-2.5">
                                        <div class="w-6 h-6 bg-indigo-500 text-white text-xs font-bold rounded flex items-center justify-center flex-shrink-0">3</div>
                            ...
                            <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-xl p-4 border border-yellow-200 dark:border-yellow-800">
                                ...
                                <div class="grid grid-cols-2 gap-2 text-xs">
                                    ...
                                    <div class="flex justify-between items-center bg-white/50 dark:bg-black/20 rounded p-2">
                                        <span class="text-gray-700 dark:text-gray-300">Mukammal:</span>
                                        <span class="font-bold text-blue-600">+5 ball</span>
                                    </div>
                                    <div class="flex justify-between items-center bg-white/50 dark:bg-black/20 rounded p-2">
                                        <span class="text-gray-700 dark:text-gray-300">Hint ishlatish:</span>
                                        <span class="font-bold text-red-600">-2 ball</span>
                                    </div>
                                    <div class="flex justify-between items-center bg-white/50 dark:bg-black/20 rounded p-2">
                                        <span class="text-gray-700 dark:text-gray-300">Streak bonus:</span>
                                        <span class="font-bold text-purple-600">+2 ball</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-5 bg-gray-50 dark:bg-gray-900">
                            <button @click="showTutorial = false"
                                class="w-full py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-xl hover:opacity-90 transition text-lg shadow-lg">
                                Tushundim! 🚀
                            </button>
                        </div>
                    </div>
