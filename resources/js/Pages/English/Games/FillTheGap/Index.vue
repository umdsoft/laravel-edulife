...
const currentRank = computed(() => {
    if (!props.gapMasterRanks.length) return null;

    let current = props.gapMasterRanks[0];
    for (const rank of props.gapMasterRanks) {
...
const tips = [
    { icon: '📝', text: "Bo'sh joylarni to'g'ri to'ldiring va ko'proq ball oling!" },
    ...
    <StudentLayout>
        <div class="min-h-screen pb-8">
            ...
            <div class="relative rounded-3xl p-6 md:p-8 mb-8 overflow-hidden">
                ...
                <div class="absolute inset-0 bg-gradient-to-br from-sky-600 via-blue-600 to-indigo-500 animate-gradient"></div>
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                        ...
                        <div class="flex items-center gap-4">
                            <!-- Animated Icon -->
                            <div class="relative">
                                <div class="absolute inset-0 bg-blue-400/30 rounded-2xl blur-xl animate-pulse"></div>
                                <div class="relative w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-blue-400 via-sky-400 to-cyan-500 rounded-2xl flex items-center justify-center text-3xl md:text-4xl shadow-2xl shadow-blue-500/40 transform hover:scale-105 hover:rotate-3 transition-all duration-300">
                                    📝
                                </div>
                            </div>
                            <div>
                                <h1 class="text-3xl md:text-5xl font-black text-white mb-1 tracking-tight">
                                    Fill <span class="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-400">the Gap</span>
                                </h1>
                                <p class="text-white/80 text-sm md:text-lg font-medium">
                                    Bo'sh joylarni <span class="text-yellow-300 font-bold">to'g'ri</span> to'ldiring!
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 grid grid-cols-2 lg:grid-cols-4 gap-3">
                        <div class="group bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 hover:bg-white/20 hover:border-white/30 transition-all hover:scale-[1.02]">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-white font-bold text-lg">{{ stats.games_played || 0 }}</p>
                        ...
                        <div class="group bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 hover:bg-white/20 hover:border-white/30 transition-all hover:scale-[1.02]">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-white font-bold text-lg">{{ stats.accuracy || 0 }}%</p>
                        ...
                        <div class="group bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 hover:bg-white/20 hover:border-white/30 transition-all hover:scale-[1.02]">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-white font-bold text-lg">{{ stats.best_streak || 0 }}</p>
                        ...
                        <div class="group bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 hover:bg-white/20 hover:border-white/30 transition-all hover:scale-[1.02]">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-white font-bold text-sm">{{ currentRank?.name || 'Yangi' }}</p>
            ...
            <div v-if="gameModes && gameModes.length" class="mb-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                    <div
                        ...
                        :key="mode.id"
                        class="bg-white dark:bg-gray-800 rounded-2xl p-4 cursor-pointer transform hover:scale-105 transition-all shadow-md hover:shadow-xl border-2"
                        :class="[
            ...
            <div v-if="categories && categories.length" class="mb-8">
                ...
                <div class="flex flex-wrap gap-3">
                    <button
                        ...
                        :key="category.id"
                        class="px-4 py-2 rounded-xl font-medium transition-all shadow-md hover:shadow-lg"
                        :class="[
                            selectedCategory === category.id
                                ? 'bg-blue-500 text-white dark:bg-blue-600'
                                : 'bg-white dark:bg-gray-800 text-gray-900 dark:text-white hover:bg-blue-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700'
                        ]"
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 md:gap-4">
                    ...
                    >
                        ...
                        <Link
                            v-if="level.unlocked"
                            :href="route('student.english.games.fill-the-gap.play', { level: level.level_number })"
                        ...
                        >
                            ...
                            <!-- Level Info -->
                            <div class="text-white/80 text-xs text-center mb-2">
                                {{ level.sentences_count }} gap • {{ level.gaps_per_sentence }} gap/har
                            </div>
                            ...
                            <!-- Best Score -->
                            <div v-if="level.best_score" class="text-white/70 text-xs">
            ...
            <div v-if="achievements && achievements.length" class="mb-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div
                        ...
                        :key="achievement.id"
                        class="bg-white dark:bg-gray-800 rounded-2xl p-4 text-center shadow-md border border-gray-200 dark:border-gray-700 transition-all hover:shadow-lg"
            ...
            <!-- Gap Master Ranks -->
            <div v-if="gapMasterRanks && gapMasterRanks.length" class="mb-8">
                <h2 class="text-lg md:text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                    <span>👑</span> Bo'shliq Ustasi Darajalari
                </h2>
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-md border border-gray-200 dark:border-gray-700">
                    <div class="flex overflow-x-auto gap-4 pb-2">
                        <div
                            v-for="rank in gapMasterRanks"
                            :key="rank.id"
                            class="flex-shrink-0 text-center p-3 rounded-xl min-w-[120px] border-2 transition-all"
                            :class="[
                        ...
                        >
                            ...
                            <div class="text-gray-900 dark:text-white font-medium text-sm">{{ rank.name }}</div>
        ...
        <Teleport to="body">
            ...
            >
                <div class="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-lg my-4 relative animate-scale-in">
                    ...
                    <!-- Header -->
                    <div class="bg-gradient-to-r from-sky-600 to-blue-600 p-5 rounded-t-2xl">
                        <div class="flex items-center gap-3">
                            <span class="text-3xl">📝</span>
                            <div>
                                <h2 class="text-xl font-black text-white">Fill the Gap</h2>
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div class="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 border border-green-200 dark:border-green-800">
                            ...
                            <p class="text-green-700 dark:text-green-300 text-sm">
                                Jumladagi <strong>bo'sh joylarni to'g'ri so'zlar</strong> bilan to'ldiring! Qanchalik aniq to'ldirsangiz, shunchalik ko'p ball olasiz.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center gap-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-2.5">
                                    ...
                                    <p class="text-gray-800 dark:text-gray-200 text-sm">Jumlani o'qing va bo'sh joyni toping</p>
                                </div>
                                <div class="flex items-center gap-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-2.5">
                                    <div class="w-6 h-6 bg-blue-500 text-white text-xs font-bold rounded flex items-center justify-center flex-shrink-0">2</div>
                                    <p class="text-gray-800 dark:text-gray-200 text-sm">To'g'ri so'zni tanlang yoki yozing</p>
                                </div>
                                <div class="flex items-center gap-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-2.5">
                                    <div class="w-6 h-6 bg-blue-500 text-white text-xs font-bold rounded flex items-center justify-center flex-shrink-0">3</div>
                        ...
                        <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-xl p-4 border border-yellow-200 dark:border-yellow-800">
                            ...
                            <div class="grid grid-cols-2 gap-2 text-xs">
                                ...
                                <div class="flex justify-between items-center bg-white/50 dark:bg-black/20 rounded p-2">
                                    ...
                                    <span class="font-bold text-blue-600">+bonus</span>
                                </div>
                                <div class="flex justify-between items-center bg-white/50 dark:bg-black/20 rounded p-2">
                        ...
                        <button
                            @click="showTutorial = false"
                            class="w-full py-3 bg-gradient-to-r from-sky-600 to-blue-600 text-white font-bold rounded-xl hover:shadow-lg transition-all text-sm"
                        >
                            Tushundim! 🚀
                        </button>
                    </div>
