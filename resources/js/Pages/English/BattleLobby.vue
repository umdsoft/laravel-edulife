    ...
    <StudentLayout>
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600 dark:text-gray-400">Real-time ingliz tili bellashuvlarida raqobatlashing!</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 mb-8 shadow-lg">
                <div class="flex items-center space-x-4">
                    <div
                        class="w-16 h-16 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center text-white text-2xl">
            ...
            <div v-if="isSearching" class="text-center py-12">
                <div class="relative w-32 h-32 mx-auto mb-6">
                    ...
                    <div
                        class="absolute inset-4 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center">
            ...
            <template v-else>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div v-for="mode in battleModes" :key="mode.id" @click="selectedMode = mode.id"
                    ...
                    <div class="space-y-3">
                        <div v-for="battle in battleHistory.slice(0, 5)" :key="battle.id"
                            ...
                            <div class="flex items-center space-x-3">
                                <div class="w-3 h-3 rounded-full" :class="battle.won ? 'bg-green-500' : 'bg-red-500'">
                                </div>
