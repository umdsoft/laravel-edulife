    ...
    <div>
        ...
        <div v-if="phase === 'learn'" class="space-y-6">
            ...
            <div class="text-center">
                <div
                    class="inline-flex items-center gap-2 bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-300 px-4 py-2 rounded-full text-sm font-medium mb-4">
                    <span>💬</span>
            ...
            <div
                ...
                <div class="space-y-4 max-h-80 overflow-y-auto">
                    <div v-for="(line, i) in dialogue" :key="i" :class="[
            ...
            <div class="flex justify-center">
                <button v-if="!showFullDialogue" @click="nextDialogueLine"
                ...
                <button v-else @click="startRolePlay"
        ...
        <div v-else-if="phase === 'practice'" class="space-y-6">
            ...
            <QuizExercise v-if="rolePlay.length > 0" :question="rolePlay[currentRolePlayIndex]"
                @answer="handleRolePlayAnswer" @next="handleRolePlayNext" />
        </div>
